...
export class CompanyService {
  ...
  async create(createCompanyDto: CreateCompanyDto): Promise<Company> {
    try {
      ...
      throw new BadRequestException('Failed to create company: ' + (error as Error).message);
    }
  }
  ...
  async findAll(): Promise<Company[]> {
    try {
      ...
      throw new BadRequestException('Failed to fetch companies: ' + (error as Error).message);
    }
  }
  ...
  async findOne(id: string): Promise<Company> {
    try {
      ...
      throw new BadRequestException('Failed to fetch company: ' + (error as Error).message);
    }
  }
  ...
  async findByUserEmail(email: string): Promise<Company> {
    try {
      ...
      throw new BadRequestException('Failed to fetch company by email: ' + (error as Error).message);
    }
  }
  ...
  async update(id: string, updateCompanyDto: UpdateCompanyDto): Promise<Company> {
    try {
      ...
      throw new BadRequestException('Failed to update company: ' + (error as Error).message);
    }
  }
  ...
  async remove(id: string): Promise<void> {
    try {
      ...
      throw new BadRequestException('Failed to delete company: ' + (error as Error).message);
    }
  }
}
